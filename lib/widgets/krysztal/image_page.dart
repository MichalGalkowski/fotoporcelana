...
class _ImagePageState extends State<ImagePage> {
  ...
  void initState() {
    super.initState();
    _imageFiles = Provider.of<KrysztalOptions>(context, listen: false).getFiles;
  }
  ...
  Future _pickImage(ImageSource source) async {
    try {
      ...
      setState(() {
        Provider.of<KrysztalOptions>(context, listen: false).addFile(img);
                            ...
                            children: [
                              ...
                              IconButton(
                                onPressed: () => {
                                  setState(
                                    () {
                                      Provider.of<KrysztalOptions>(context,
                                              listen: false)
                                          .removeFile(item);
                                      Provider.of<KrysztalOptions>(context,
                                              listen: false)
